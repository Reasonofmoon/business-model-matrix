...
Strategyzer **Business Model Canvas** + **10대 비즈니스 프레임워크** 교차 분석 웹앱입니다.  
...
| **프레임워크 인사이트** | SWOT, Porter, Blue Ocean, JTBD, 경쟁사 벤치마크, PDCA, Ansoff, OKR, Unit Econ, VPC |
...
5. **경쟁사 벤치마크** — 비교군·우위/갭·이길 메시지·모니터링  
6. **PDCA 사고법** — Plan-Do-Check-Act 운영 루프  
7. **Ansoff** — 성장 경로  
8. **OKR** — 분기 목표/핵심결과  
9. **Unit Economics** — LTV·CAC·공헌이익  
10. **Value Proposition Canvas** — 과업·고통·이득 정합  
